...
if len(sys.argv)<4:
    print('python file.py df-val-phylopgm-input df-test-phylopgm-input info_tree')
    exit(0)
...
#dtrain = pd.read_csv(fname+'/df-pred-sampled-ortho-val.csv', index_col=0)
...
#dtest = pd.read_csv(fname+'/df-pred-ortho-test.csv', index_col=0)
